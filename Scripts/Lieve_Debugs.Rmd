...
groundbeetle_community <- groundbeetle_community %>%
...
na_columns <- names(groundbeetle_community)[colSums(is.na(groundbeetle_community)) == nrow(groundbeetle_community)]

# remove empty columns
groundbeetle_community <- groundbeetle_community %>% select(-one_of(na_columns))
print(groundbeetle_community) # 40 columns
```

# calculating community thermal preferences
```{r}
glimpse(groundbeetle_community)
view(groundbeetle_community)
